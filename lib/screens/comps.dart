          ...
          child: Container(
            ...
            Text("Sem ${sems[0]} Subjects", style: GoogleFonts.delaGothicOne(fontSize: 25)),
              ...
              Subject(subjectName: sem3[0], sem: 3, imageUrl: "assets/images/departments/fy.png", userModel: widget.userModel, firebaseUser: widget.firebaseUser,),
                ...
                Text("Sem ${sems[2]} Subjects", style: GoogleFonts.delaGothicOne(fontSize: 25)),
                const SizedBox(height: 25),
                ...
                Text("Sem ${sems[3]} Subjects", style: GoogleFonts.delaGothicOne(fontSize: 25)),
                const SizedBox(height: 25),
                ...
                Text("Sem ${sems[4]} Subjects", style: GoogleFonts.delaGothicOne(fontSize: 25)),
                const SizedBox(height: 25),
                ...
                Text("Sem ${sems[5]} Subjects", style: GoogleFonts.delaGothicOne(fontSize: 25)),
                const SizedBox(height: 25),
